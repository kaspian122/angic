...
Backend will be available at `http://localhost:4200/api`

To change backend server location, change `proxy.config.json`, or create new config file and use it in `ng serve` command
